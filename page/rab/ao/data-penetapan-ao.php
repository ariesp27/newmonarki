...
WHERE jenis = 'AO' AND status = '3'") or die (mysql_error());
?>
                            				...
                            				?>
                            					<tr>
                                                    ...
                                                    <td>
                                                        ...
                                                        $rab = mysql_fetch_array(mysql_query("SELECT * FROM newdetailanggaran
                                                        WHERE status IN ('5','6','7','8') AND randomid = '".$row['randomid']."'"));
                                                        echo "Rp ".number_format( $rab['hrgsatuanjasa'],0,'','.'); ?>
                                                    </td>
                                                    ...
                                                    <td class="text-center">
                                                         ...
                                                         <a href="index.php?tambah-rab-ao=<?php echo $row["kodedetail"]?>" type="button"><i class="fa fa-plus fa-2x"></i></a>
                                                         
                                                         <a href="index.php?update-rab-ao=<?php echo $row["randomid"]?>" type="button"><i class="fa fa-pencil-square-o fa-2x"></i></a>
                                                         <a href="#" id="delete-rab-ao=<?php echo $row["kodedetail"]?>&delete-rab-ango=<?php echo $row["kodeanggaran"]?>" class="delete">
