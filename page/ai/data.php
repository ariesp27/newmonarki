                            					...
                            					<tr>
                                                    ...
                                                    <td class="text-center">
                                                        <a href="#" class="detail" data-id="<?php echo $row["kodedetail"]; ?>" role="button" data-toggle="modal">
                                                         ...
                                                         <a href="index.php?update-ai=<?php echo $row["randomid"]?>" type="button"><i class="fa fa-pencil-square-o fa-2x"></i></a>
                                                         <!--
                                                         <a href="index.php?penetapan-ai=<?php echo $row["kodedetail"]?>" type="button"><i class="fa fa-thumbs-o-up fa-2x"></i></a>
                                                         -->
                                                         <a href="#" id="delete-ai=<?php echo $row["kodedetail"]?>&delete-ang=<?php echo $row["kodeanggaran"]?>" class="delete">
