...
WHERE status = '4' AND newdetailanggaran.kodedetail = '$detail'") or die (mysql_error());
...
<div class="row">
    ...
    -->
          ...
          <div class="row">
            <div class="col-md-5"><label>Jasa Sesudah</label></div>
            <div class="col-md-1"> : </div>
            <div class="col-md-6"><?php echo $rowDetail["volumejasa"]; ?></div>
          </div>
          <div class="row">
            <div class="col-md-5"><label>Material Sesudah</label></div>
            <div class="col-md-1"> : </div>
