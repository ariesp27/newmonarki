...
// deklarasikan variabel
	...
	header("location: index.php?monitor-eva-rabao");
}

?>
<br />
<body>
<form name="bulk_action_form" action="form-eva-rabao.php" method="post" onSubmit="return delete_confirm();"/>
          <div class="col-md-8">
                                ...
                                <div class="col-md-12 text-center">
                                    ...
                                    <tr >
                                        ...
                                        <td align="center">
                                           ...
                                           <?php } ?>
                                           <?php if($permintaan['status']==8){?>
                                           <a title="detail" href="#" class="detail-eva" data-id="<?php echo $permintaan['kodedetail']; ?>" role="button" data-toggle="modal fade"><i class="fa fa-search-plus" aria-hidden="true"></i></a>
                                           <?php } ?>
                                           <?php if ($permintaan['status'] == '6') {?><a title="evaluasi" href="#" class="evaluasi" id="<?php echo $permintaan['kodedetail']; ?>" role="button" data-toggle="modal"><i class="fa fa-check square" aria-hidden="true"></i></a><?php } else{echo "";}?>
                                           ...
                                           <a title="delete" href="#" id="del-eva-rabao=<?php echo $rowC["kodedetail"]?>" class="delete">
...
$(document).ready( function () {
 ...
 $(document).on('click','.detail',function(e){
    e.preventDefault();
    $("#detail").modal('show');
    $.post('page/evaluasi/ao/detail-rabao.php',
  ...
  $(document).on('click','.detail-eva',function(e){
    e.preventDefault();
    $("#detail").modal('show');
    $.post('page/evaluasi/ao/detail-eva-ao.php',
    {id:$(this).attr('data-id')},
    function(html){
    $(".modal-body").html(html);
    }   
 ...
 $(document).on('click','.evaluasi',function(e){
    e.preventDefault();
    $("#evaluasi").modal('show');
    $.post('page/evaluasi/ao/form-eva-rabao.php',
    {id:$(this).attr('id')},
    function(html){
 ...
 $(function() {
    ...
    $("#simpan-approve").click(function(){
        $.ajax({
                type: "POST",
                url: "page/evaluasi/ao/form-eva-rabao.php",
    ...
    <div class="modal-content wrap-dialog" style="border-radius: 0;">
      <!-- dialog body -->
       <div class="modal-header bg-primary">
            ...
            <h4 class="modal-title text-center">Detail Monitoring Evaluasi RAB AO</h4>
       </div>
  ...
  <div class="modal-dialog ">
    <div class="modal-content wrap-dialog" style="border-radius: 0;">
      <!-- dialog body -->
       <div class="modal-header bg-primary">
            <button type="button" class="close" data-dismiss="modal">&times;</button>
            <h4 class="modal-title text-center">Monitoring Status RAB AO</h4>
       </div>
