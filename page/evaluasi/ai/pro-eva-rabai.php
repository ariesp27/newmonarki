                        ...
                        <div class="panel-body">
                            <div class="table-responsive">
                                ...
                                <div class="col-md-12 text-center">
                                    <h4>MONITORING EVALUASI RAB AI<br /></h4> 
                                    ...
                                    <?php	
                                        ...
                                        $sqlangg = mysql_query("SELECT 
                                            ...
                                            WHERE jenis = 'AI'  AND status = '6' OR jenis = 'AI' AND status = '7'
                                            OR jenis = 'AI' AND status = '8'
                                            ");
                                    ...
                                    <tr >
                                        ...
                                        <td align="center">
                                           ...
                                           <a title="delete" href="#" id="del-eva-rabai=<?php echo $rowC["kodedetail"]?>" class="delete">
