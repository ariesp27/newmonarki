...
<br />
<body>
<form name="bulk_action_form" action="form-app-rabao.php" method="post" onSubmit="return delete_confirm();"/>
          <div class="col-md-8">
                        ...
                        <div class="panel-body">
                            <div class="table-responsive">
                                ...
                                <div class="col-md-12 text-center">
                                    <h4>MONITORING APPROVAL RAB AO<br /></h4> 
                                    ...
                                    <?php	
                                        ...
                                        $sqlangg = mysql_query("SELECT 
                                            ...
                                            WHERE jenis = 'AO'  AND status = '5' OR jenis = 'AO' AND status = '6'
                                            OR jenis = 'AO' AND status = '7'");
                                    ...
                                    <tr >
                                        ...
                                        <td align="center">
                                           ...
                                           <?php if ($permintaan['status'] == '5') {?>
                                           <a title="approve" href="#" class="approve" id="<?php echo $permintaan['kodedetail']; ?>" role="button" data-toggle="modal"><i class="fa fa-sign-in" aria-hidden="true"></i></a><?php } else{echo "";}?>
                                           <?php $delete = mysql_query("SELECT * FROM newdetailanggaran WHERE status = '6' AND randomid = '".$permintaan['randomid']."'");
                                           $rowC = mysql_fetch_array($delete);?>
                                           <a title="delete" href="#" id="del-apprab-ao=<?php echo $rowC["kodedetail"]?>" class="delete">
...
$(document).ready( function () {
 ...
 $(document).on('click','.detail',function(e){
    e.preventDefault();
    $("#detail").modal('show');
    $.post('page/request/detail-rab-ao.php',
 ...
 $(document).on('click','.approve',function(e){
    e.preventDefault();
    $("#approve").modal('show');
    $.post('page/request/form-app-rabao.php',
    {id:$(this).attr('id')},
    function(html){
 ...
 $(function() {
    ...
    $("#simpan-approve").click(function(){
        $.ajax({
                type: "POST",
                url: "page/request/form-app-rabao.php",
