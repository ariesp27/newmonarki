...
<br />
<body>
<form name="bulk_action_form" action="pro-approve-form-ao.php" method="post" onSubmit="return delete_confirm();"/>
          <div class="col-md-8">
                                ...
                                <div class="col-md-12 text-center">
                                    ...
                                    <tr >
                                        ...
                                        <td align="center">
                                           ...
                                           <?php } else{echo "";}?>
                                           <?php $delete = mysql_query("SELECT * FROM newdetailanggaran WHERE status = '1' AND randomid = '".$permintaan['randomid']."'");
                                           $rowC = mysql_fetch_array($delete);?>
                                           <a title="delete" href="#" id="delete-approve-ao=<?php echo $rowC["kodedetail"]?>" class="delete">
...
$(document).ready( function () {
 ...
 $(document).on('click','.detail',function(e){
    e.preventDefault();
    $("#detail").modal('show');
    $.post('page/request/detail-ao.php',
 ...
 $(document).on('click','.approve',function(e){
    e.preventDefault();
    $("#approve").modal('show');
    $.post('page/request/pro-approve-form-ao.php',
    {id:$(this).attr('id')},
    function(html){
 ...
 $(function() {
    ...
    $("#simpan-approve").click(function(){
        $.ajax({
                type: "POST",
                url: "page/request/pro-approve-form-ao.php",
  ...
  <div class="modal-dialog ">
    <div class="modal-content wrap-dialog" style="border-radius: 0;">
      <!-- dialog body -->
       <div class="modal-header bg-primary">
            <button type="button" class="close" data-dismiss="modal">&times;</button>
            <h4 class="modal-title text-center">Monitoring Status Usulan AO</h4>
       </div>
