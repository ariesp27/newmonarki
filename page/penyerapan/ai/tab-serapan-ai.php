<?php
$idA = mysql_real_escape_string(trim($_GET["tambah-penyerapan-ai"]));
...
<div id="wrapper">
       ...
       <div id="page-wrapper" >
           ...
           <div class="row">
                ...
                <div class="col-md-2">
                    <a href="index.php?form-penyerapan-ai=<?php echo $idA;?>" class="btn btn-sm btn-info"><i class="glyphicon glyphicon-plus"></i>Tambah Penyerapan</a>
                    <br /><br />
                </div>
