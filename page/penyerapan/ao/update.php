...
$sqlA= mysql_query("SELECT * FROM pembayaran WHERE randomid = '$idA'") or die (mysql_error());
                                    ...
                                    <div class="col-lg-6">
                                        ...
                                        <div class="form-group">
                                            <div class="row">
                                                ...
                                                <div class="col-md-7">
                                                    <input  type="text" onKeyPress="return isNumberKeyTgl(event)" class="form-control" id="datepicker2" name="tglpym" value="<?php if($rowA["tglinput"]=="0000-00-00"){}else{ echo format_tgl($rowA["tglinput"]); } ?>" data-rule-required="true" data-rule-date="true" data-msg-date="format yang benar dd/mm/yyyy" data-msg-required="mohon masukkan data tanggal input." placeholder="masukkan tanggal input" />
                                                </div>
                                            </div>
                                        </div>
