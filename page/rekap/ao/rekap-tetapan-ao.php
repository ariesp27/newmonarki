...
$sql = mysql_query("SELECT
    ...
    WHERE headeranggaran.jenis = 'AO' AND newdetailanggaran.status = '4'
    ") or die (mysql_error());
?>
                            				...
                            				?>
                            					<tr>
                                                    ...
                                                    <td class="text-center">
                                                         ...
                                                         <a title="delete" href="#" id="delete-rab-ao=<?php echo $rowC["kodedetail"]?>" class="delete">
